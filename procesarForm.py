...
def procesarFormulario(request):
    ...
    aliments_solits_liquids_no_agraden_intolera_restriccio = respuesta[
        "aliments_solits_liquids_no_agraden_intolera_restriccio"
    ]
    habitualment_menja = respuesta["habitualment_menja"]
    situacions_influencien_habits_alimentalis = respuesta[
    ...
    situacions_influencien_habits_eliminacio = respuesta[
    ...
    resultado = rellenar_datos_6(
        dni,
        hores_dorm,
        migdia,
        qualitat_son,
        situacions_influencien_son,
        quienes_situacions_influencien_son,
        mitjans_dormir,
        altres_manifestacions,
    )
    # print(resultado)
    ...
    situacions = respuesta[
        "situacions_circumstancies_seguretat_fisica_psicologica_social"
    ]
    ...
    resultado = rellenar_datos_10(
        dni, coneix_mides, salubritat_habitat, situacions, quines, mitjans, altres
    )
    # print(resultado)
